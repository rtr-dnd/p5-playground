  ...
  return (
    <button
      ...
      className={clsx(
        ...
        props.selected && 'bg-eniaq_dark_grey/10'
      )}
    >
      {props.content}
    </button>
...
export default function Sketch() {
  ...
  return (
    <div className="touch-none">
      <div className="text-eniaq_dark_grey absolute bottom-0 left-0 right-0 p-4 text-xs opacity-40 flex justify-between items-center font-mono">
        ...
        <div className="flex-1 text-right">
          <input
            className="bg-transparent border border-eniaq_dark_grey px-1 text-right"
            value={val}
